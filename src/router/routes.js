...

  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: '文章类型', icon: 'el-icon-c-scale-to-original', auth: true }
      },
      {
        path: '/addBlog',
        name: 'AddBlog',
        component: () => import('@/views/addBlog/index'),
        meta: { title: '添加文章', icon: 'el-icon-edit-outline', auth: true }
      }
    ]
  },
    ...
    children: [
      {
        ...
        name: 'ProjectList',
        component: () => import('@/views/blogList/index'),
        meta: { title: '项目列表', icon: 'el-icon-s-operation', auth: true }
      },
      {
        path: '/projectType',
        name: 'ProjectType',
        component: () => import('@/views/blogList/index'),
        meta: { title: '项目分类', icon: 'el-icon-folder-opened', auth: true }
      }
    ]
  },
